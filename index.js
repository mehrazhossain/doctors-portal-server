...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.kn5re.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
...
function sendAppointmentEmail(booking) {
  ...
  var email = {
    ...
    <div>
        ...
        <h3>Our Address</h3>
        <p>Banani, Road #11, Block #C House #105.</p>
    ...
    */
    app.get('/available', async (req, res) => {
      ...
      services.forEach((service) => {
        ...
        // step 7:L set available to slots to make it easier
...
app.get('/', (req, res) => {
  res.send('Server is Running on Heroku Port.');
});
